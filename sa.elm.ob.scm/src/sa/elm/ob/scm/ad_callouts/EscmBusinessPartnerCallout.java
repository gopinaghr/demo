...
public class EscmBusinessPartnerCallout extends SimpleCallout {
  ...
  protected void execute(CalloutInfo info) throws ServletException {
    ...
    String zakatcertificateno = vars.getStringParameter("inpemEfinZakatcertificateno");
    String sagiano = vars.getStringParameter("inpemEfinSagiano");
    String iqamano = vars.getStringParameter("inpemEfinIqamano");
    String crnumber = vars.getStringParameter("inpemEscmCrnumber");
