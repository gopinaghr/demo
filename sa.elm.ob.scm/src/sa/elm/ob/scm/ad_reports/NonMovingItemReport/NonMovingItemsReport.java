  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      if (action.equals("")) {
        ...
        st = con
            .prepareStatement("select m_warehouse_id,name from m_warehouse where em_escm_warehouse_type  =  'MAW' and ad_client_id = ? "
        ...
        parameters.put("today", yearFormat.format(dateFormat.parse(UtilityDAO
            .convertToHijriDate(yearFormat.format(new Date())))));
        parameters.put("period", Date);
        parameters.put("periodMonth", inpPeriod);
