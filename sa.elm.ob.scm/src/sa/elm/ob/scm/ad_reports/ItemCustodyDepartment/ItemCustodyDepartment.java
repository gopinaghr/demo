  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      if (action.equals("")) {
        ...
        sqlquery = " select org.ad_org_id,org.value,org.name from ad_role_orgaccess orgaccess join ad_org org on org.ad_org_id = orgaccess.ad_org_id where orgaccess.ad_role_id =? and orgaccess.ad_client_id=? and org.ad_org_id <> '0'";
        ...
        st = con
            .prepareStatement(" select escm_beneficiary_v_id as id ,name from escm_beneficiary_v where btype= 'D' and ad_client_id=? and ad_org_id = ?  order by value asc ");
