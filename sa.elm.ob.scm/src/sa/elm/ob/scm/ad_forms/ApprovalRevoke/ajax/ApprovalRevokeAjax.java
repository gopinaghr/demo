package sa.elm.ob.scm.ad_forms.ApprovalRevoke.ajax;
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    try {
      ...
      if (action.equals("GetRevokeRecords")) {
        ...
        List<ApprovalRevokeVO> list = dao.getRevokeRecordsList(vars, vars.getClient(), windowId,
            vo, rows, offset, sortColName, sortColType, searchFlag, lang);
