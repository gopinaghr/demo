...
public class CustodyUploadTemplateDAO {
  ...
  Logger log4j = Logger.getLogger(CustodyUploadTemplateDAO.class);
  ...
  public JSONObject processUploadedCsvFile(String filePath) {
    ...
    try {
      ...
      String inpLine = "", inpDelimiter = "", inpHeaderLine = "", inpHeaderDelimiter = "";
      ...
      if (isSuccess == 1) {
        ...
        OBCriteria<CsvCustodyImport> csvTable = OBDal.getInstance().createCriteria(
            CsvCustodyImport.class);
    ...
    try {
      ...
      if (productQuery != null && objectslist.size() > 0) {
        for (int i = 0; i < objectslist.size(); i++) {
          ...
          AttributeSetInstance objAttributeSet = OBProvider.getInstance().get(
          ...
          if (objProduct.getEscmCusattribute() != null) {
            ...
            attributeBrandQuery.setParameter(1, jsonHeaderresult.get("brand").toString()
                .toLowerCase());
            ...
            attributeCycQuery.setParameter(1, jsonHeaderresult.get("cylinder").toString()
                .toLowerCase());
            ...
            attributeOilQuery.setParameter(1, jsonHeaderresult.get("oiltype").toString()
                .toLowerCase());
            ...
            attributeColorQuery.setParameter(1, jsonHeaderresult.get("color").toString()
                .toLowerCase());
            ...
            attributeChassisQuery.setParameter(0, jsonHeaderresult.get("chasis").toString()
                .toLowerCase());
            ...
            attributePlateQuery.setParameter(0, jsonHeaderresult.get("plate").toString()
                .toLowerCase());
            ...
            attributeYearQuery.setParameter(0, jsonHeaderresult.get("year").toString()
                .toLowerCase());
            ...
            if ((objectsAttrYearlist.size() > 0)) {
              ...
              AttributeInstance objInstance = OBProvider.getInstance().get(AttributeInstance.class);
              objInstance.setAttribute(OBDal.getInstance().get(Attribute.class,
                  objectsAttributeYear[1].toString()));
              objInstance.setAttributeSetValue(objAttributeSet);
            ...
            attributeDescQuery.setParameter(0, jsonHeaderresult.get("cusDesc").toString()
                .toLowerCase());
            ...
            if ((objectsAttrDesclist.size() > 0)) {
              ...
              AttributeInstance objInstance = OBProvider.getInstance().get(AttributeInstance.class);
              objInstance.setAttribute(OBDal.getInstance().get(Attribute.class,
                  objectsAttributeDesc[1].toString()));
              objInstance.setAttributeSetValue(objAttributeSet);
          ...
          objCustody.setBeneficiaryIDName(OBDal.getInstance().get(BeneficiaryView.class,
              objects[1].toString()));
          ...
          OBDal.getInstance().flush();
          // insert Transaction
          Escm_custody_transaction objTransaction = OBProvider.getInstance().get(
              Escm_custody_transaction.class);
          objTransaction.setEscmMrequestCustody(objCustody);
          objTransaction.setBtype("E");
          objTransaction.setBname(OBDal.getInstance().get(BeneficiaryView.class,
              objects[1].toString()));
      ...
      while ((inpLine = inpReader.readLine()) != null) {
        ...
        if (fields.length < 11) {
          ...
          if (StringUtils.isEmpty(fields[0])) {
            failed += 1;
            description.append("Employee Number is empty at line No.<b>" + lineNo
                + "</b> in the data file.<br>");
            br = "<br>";
          }
          if (StringUtils.isEmpty(fields[1])) {
            failed += 1;
            description.append("Employee Name is empty at line no.<b>" + lineNo
                + "</b> in the data file.<br>");
            br = "<br>";
          } else {
            String employee = fields[0];
            OBCriteria<BusinessPartner> empListCriteria = OBDal.getInstance().createCriteria(
