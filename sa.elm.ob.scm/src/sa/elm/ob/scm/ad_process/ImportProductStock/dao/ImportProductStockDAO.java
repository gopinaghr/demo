...
/**
 * @author Divya Servlet implementation class Import Product Stock in Phsical Inventory
 */

public class ImportProductStockDAO {

  Logger log4j = Logger.getLogger(ImportProductStockDAO.class);
      ...
      while ((inpLine = inpReader.readLine()) != null) {
        ...
        if (fields.length < 2) {
          ...
          if (StringUtils.isEmpty(fields[1])) {
            failed += 1;
            description.append("Stock Quantity  is empty at line no.<b>" + lineNo
                + "</b> in the data file.<br>");
            br = "<br>";
          }
