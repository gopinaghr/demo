                                             ...
                                             <td class="TextBox_ContentCell">
                                                <select id="inpMIRId" class="ComboKey Combo_TwoCells_width" onchange="disableTags(this.value)">
                                                   ...
                                                   <%   if(mirArray.length() > 0){
                                                   	...
                                                   	<option value='<%= objectInArray.get("Id")%>' ><span><%= objectInArray.get("MIRNo")+"-"+ objectInArray.get("Description") +"-"+ objectInArray.get("Beneficiary") %></span></option>
                                                   <%}}%>
                                                </select>
                                             </td>
                                          </tr>
                                                ...
                                                <select id="inpTagFrom" class="ComboKey Combo_TwoCells_width">
                                                  <option value="0"><span>--select--</span></option>
                                                   <%   if(tagArray.length() > 0){
                                                   	...
                                                   	<option value='<%= objectInArray.get("DocumentNo")%>' ><span><%= objectInArray.get("DocumentNo")+"-"+objectInArray.get("Status")+"-"+objectInArray.get("Description")%></span></option>
                                                   <%}}%>
                                                </select>
                                             </td>
                                          </tr>
